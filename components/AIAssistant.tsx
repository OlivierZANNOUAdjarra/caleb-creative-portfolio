      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-40 right-6 z-50 flex h-[28rem] w-[calc(100vw-3rem)] max-w-sm flex-col overflow-hidden rounded-xl2 border border-ink/10 bg-paper shadow-2xl shadow-ink/20 dark:border-white/10 dark:bg-[#0f172a]"
          >
