...
export default function SiteHeader() {
  ...
  return (
    <>
      <header
        className={`fixed left-0 right-0 top-0 z-[200] flex items-center justify-between border-b border-ink/10 bg-paper/90 px-5 py-3.5 backdrop-blur-md transition-shadow dark:border-white/10 dark:bg-[#0F1416]/90 sm:px-10 ${
